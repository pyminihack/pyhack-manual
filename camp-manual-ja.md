...
- 別途、調整用スプレットシートに各自記入する
    - 当日の説明の時間に調整を行う
- 荷物はなるべく各自の部屋に持っていく
- 冬は2Fが床暖房になるので、PCなど床に置きっぱなしにしないようにすること
...
- 行き
	- 北陸新幹線上田駅にて下車
		- 金曜日13時のバスに間に合う列車は「member」シート最下部に記載あり
	- 2020年1月現在、片道6260円(東京駅からの自由席)

- 帰り
	- 北陸新幹線上田駅から乗車
		- 最終日は14時以降の列車に乗る人が多い
	- 2020年1月現在、片道6260円(東京駅までの自由席)

- [えきねっと](https://www.eki-net.com)
	- JR東日本管内の新幹線のチケットがwebサイトにて買える(特急や乗車券も)
	- 2022年1月現在、原則として発券不要で、SUICA、PASMOをチケットとして利用可能(要事前登録)
	- 列車によっては10-35%オフで買える(えきねっとトクだ値)
	- えきねっとトクだ値適用かつ未発券の場合、予約日(購入申込日)から3ヶ月以内なら無料で何度でも変更可能
